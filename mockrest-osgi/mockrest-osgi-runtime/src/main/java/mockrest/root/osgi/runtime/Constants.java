...
public class Constants {
    ...
    public static final String SCRIPTS_CONF_PATH = "conf/scripts.json";

    public static final String BASE_DIR_NAME = "mockrest";

    public static final String PID_FILENAME = "PID";

    public static final String OSGI_CONF_FILE = "static/felix.properties";

    public static final String OUTPUT_DIR_CONF = "conf";
